	...
	return (
		<>
			<h1 className="text-lg md:text-3xl font-bold text-center">
				ACTUALMENTE ESTAMOS TRABAJANDO (todavia no esta lista) EN LA TECNICA PROBADA DE 3 PASOS PARA DUPLICAR (X2) LOS CLIENTES DE UNA MARCA DE TECNOLOGIA EN MENOS DE 3 MESES
			</h1>
