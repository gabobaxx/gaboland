...
export default function About() {
	return (
		<>
			...
			<Box variant="layout.containers.paragraph">
				<p>
					I am always looking for books, articles and podcasts that leave me a
					technical or ideological teaching to quesion my way of thinking and
					acting. If you have one of this resources contact me and show it to
					me.
				</p>
			</Box>
			...
			<Box variant="layout.containers.paragraph">
				<p>
					I plan to learn about Blockchain and Artificial Inteligence because I
					think they will be a help for the advancement of humanity. If you have
					knowledge about this topics contact me.
				</p>
			</Box>
